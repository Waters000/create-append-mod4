...
listEl.appendChild(optionsEl);  ///target of where it goes first
...
var foods = ["Apple", "Pizza", "Henry"]

for (var i=0; i< foods.length; i++) {
    var optionsEl = document.createElement('option')
    optionsEl.textContent = foods[i];
